...
public class WDRenderTypes extends RenderType {
    ...
    public WDRenderTypes(String s, VertexFormat format, VertexFormat.Mode mode, int i, boolean b1, boolean b2, Runnable runnable1, Runnable runnable2) {
    ...
    // 1. Заменяем EYES_ALPHA_TRANSPARENCY на настоящий аддитивный blend
    public static RenderType getEyesAlphaEnabled(ResourceLocation locationIn) {
        CompositeState state = CompositeState.builder()
                ...
                .setDepthTestState(EQUAL_DEPTH_TEST) // ← как в 1.20.1
                .createCompositeState(true);
        return create("eye_alpha", DefaultVertexFormat.NEW_ENTITY,
    ...
    public static RenderType getHologramLights() {
        return create("hologram_lights", DefaultVertexFormat.POSITION_COLOR, VertexFormat.Mode.QUADS, 256, true, true, CompositeState.builder()
    ...
    public static RenderType getGel(ResourceLocation locationIn) {
        return create("ferrouslime_gel", DefaultVertexFormat.NEW_ENTITY, VertexFormat.Mode.QUADS, 256, true, true, CompositeState.builder()
                .setTextureState(new TextureStateShard(locationIn, false, false))
                .setCullState(NO_CULL)
                .setTransparencyState(RenderStateShard.TRANSLUCENT_TRANSPARENCY)
                .setLightmapState(LIGHTMAP)
    ...
    public static RenderType getRadiationGlow(ResourceLocation locationIn) {
        return create("radiation_glow", DefaultVertexFormat.POSITION_TEX_COLOR, VertexFormat.Mode.QUADS, 256, false, true, CompositeState.builder()
                .setCullState(NO_CULL)
                .setTextureState(new TextureStateShard(locationIn, false, false))
                .setTransparencyState(RenderStateShard.TRANSLUCENT_TRANSPARENCY)
                .setDepthTestState(LEQUAL_DEPTH_TEST)
    ...
    public static RenderType getBlueRadiationGlow(ResourceLocation locationIn) {
        return create("blue_radiation_glow", DefaultVertexFormat.POSITION_TEX_COLOR, VertexFormat.Mode.QUADS, 256, false, true, CompositeState.builder()
                .setCullState(NO_CULL)
                .setTextureState(new TextureStateShard(locationIn, false, false))
                .setTransparencyState(RenderStateShard.TRANSLUCENT_TRANSPARENCY)
                .setDepthTestState(LEQUAL_DEPTH_TEST)
    ...
    public static RenderType getGelTriangles(ResourceLocation locationIn) {
        return create("ferrouslime_gel_triangles", DefaultVertexFormat.NEW_ENTITY, VertexFormat.Mode.TRIANGLES, 256, true, true, CompositeState.builder()
                .setTextureState(new TextureStateShard(locationIn, false, false))
                .setCullState(NO_CULL)
                .setTransparencyState(RenderStateShard.TRANSLUCENT_TRANSPARENCY)
                .setLightmapState(LIGHTMAP)
    ...
    public static RenderType getHologram(ResourceLocation locationIn) {
        return create("hologram", DefaultVertexFormat.POSITION_TEX_COLOR, VertexFormat.Mode.QUADS, 256, false, true, CompositeState.builder()
    ...
    public static RenderType getRedGhost(ResourceLocation locationIn) {
        return create("red_ghost", DefaultVertexFormat.NEW_ENTITY, VertexFormat.Mode.QUADS, 256, false, true, CompositeState.builder()
                .setCullState(NO_CULL)
                .setTextureState(new TextureStateShard(locationIn, false, false))
                .setTransparencyState(EYES_ALPHA_TRANSPARENCY)
                .setWriteMaskState(COLOR_DEPTH_WRITE)
    ...
    public static RenderType getCaveMapBackground(ResourceLocation locationIn, boolean showBackground) {
        CompositeState rendertype$state = CompositeState.builder()
                ...
                .createCompositeState(false);
        return create("cave_map_background", DefaultVertexFormat.POSITION_TEX_COLOR, VertexFormat.Mode.QUADS, 256, false, true, rendertype$state);
    }

    public static RenderType getBookWidget(ResourceLocation locationIn, boolean sepia) {
        if(sepia){
            return create("book_widget", DefaultVertexFormat.NEW_ENTITY, VertexFormat.Mode.QUADS, 256, false, true, CompositeState.builder()
                    .setCullState(NO_CULL)
                    .setTextureState(new TextureStateShard(locationIn, false, false))
                    .setTransparencyState(RenderStateShard.TRANSLUCENT_TRANSPARENCY)
                    .setOverlayState(OVERLAY)
            ...
            return NeoForgeRenderTypes.getUnlitTranslucent(locationIn);
        }
